...
class StepFunctionsStateMachine:
    ...
    def __init__(self) -> None:
        ...
        self.state_machine_name: Optional[str] = None
    ...
    def create(
        self, name: str, definition: Dict[str, Any], role_arn: str
    ) -> Optional[str]:
        """
    ...
    def update(
        self, definition: Dict[str, Any], role_arn: Optional[str] = None
    ) -> None:
        """
        ...
        try:
            ...
            self.stepfunctions_client.update_state_machine(**kwargs)  # type: ignore
    ...
    def find(self, state_machine_name: str) -> Optional[str]:
        """
    ...
    def start_run(
        self, run_name: str, run_input: Optional[Dict[str, Any]] = None
    ) -> Any:
        """
        ...
        try:
            ...
            if run_input is not None:
                kwargs["input"] = json.dumps(run_input, default=str)
    ...
    def list_runs(self, run_status: Optional[str] = None) -> Any:
        """
        ...
        try:
            ...
            response = self.stepfunctions_client.list_executions(**kwargs)  # type: ignore
    ...
    def stop_run(self, run_arn: str, cause: str) -> None:
        """
        Stops a run.
