...
Aspects.of(app).add(
    ApplyVpcOnCustomResource(
        ...
        security_group_logical_ids=stack.vehicle_simulator_construct.cdk_lambdas_vpc_construct.security_groups,
        subnet_names=stack.vehicle_simulator_construct.cdk_lambdas_vpc_construct.subnets,
    )
)
