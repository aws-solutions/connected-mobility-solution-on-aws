...
def test_handler(
    ...
    response = main.handler(custom_resource_create_event, context)
...
def test_create_uuid(custom_resource_create_event: Dict[str, Any]) -> None:
    ...
    response = main.create_uuid(custom_resource_create_event)
...
def test_send_cloud_formation_response(
    ...
    main.send_cloud_formation_response(
...
def test_create_console_config(custom_resource_create_event: Dict[str, Any]) -> None:
    ...
    response = main.create_console_config(custom_resource_create_event)
...
def test_detach_iot_policy(
    ...
    main.detach_iot_policy(custom_resource_delete_event)
...
def test_create_userpool_user(custom_resource_create_event: Dict[str, Any]) -> None:
    ...
    main.create_userpool_user(custom_resource_create_event)
