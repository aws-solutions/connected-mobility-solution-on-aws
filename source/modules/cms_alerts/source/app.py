...
from .infrastructure.cms_alerts_stack import CmsAlertsStack
...
Aspects.of(app).add(
    ApplyVpcOnCustomResource(
        ...
        security_group_logical_ids=stack.alerts_construct.cdk_lambda_vpc_config_construct.security_groups,
        subnet_names=stack.alerts_construct.cdk_lambda_vpc_config_construct.subnets,
    )
)
