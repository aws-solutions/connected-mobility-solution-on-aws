...
def fixture_mock_well_known_jwks_valid() -> Generator[None, None, None]:
    with responses.RequestsMock() as mock:
        mock.get(
            url=f"{TEST_ISSUER}/.well-known/jwks.json",
...
def fixture_mock_well_known_jwks_invalid_key_error() -> Generator[None, None, None]:
    with responses.RequestsMock() as mock:
        mock.get(url=f"{TEST_ISSUER}/.well-known/jwks.json", body=KeyError())
        yield
...
@pytest.fixture(name="valid_service_access_token", scope="session")
def fixture_valid_service_access_token() -> str:
    return str(tokens_and_keys[VALID_SERVICE_ACCESS_TOKEN_KID]["token"])


@pytest.fixture(name="valid_id_token_claims", scope="session")
...
@pytest.fixture(name="valid_access_token_claims", scope="session")
...
@pytest.fixture(name="invalid_claims_access_token", scope="session")
...
# =============== EVENTS ===============
@pytest.fixture(name="token_validation_event_valid_id_token", scope="session")
...
@pytest.fixture(name="token_validation_event_valid_access_token", scope="session")
...
@pytest.fixture(name="token_validation_event_valid_service_token", scope="session")
...
@pytest.fixture(name="token_validation_event_invalid_token_claims", scope="session")
...
@pytest.fixture(name="token_validation_event_invalid_exp_token", scope="session")
...
@pytest.fixture(name="token_validation_event_invalid_token", scope="session")
...
@pytest.fixture(name="token_validation_event_incorrect_kid_token", scope="session")
...
@pytest.fixture(name="token_validation_event_expired_token", scope="session")
...
@pytest.fixture(
    name="token_validation_event_invalid_scope_service_token", scope="session"
)
...
# =============== BOTO ===============
@pytest.fixture(name="token_validation_idp_config_secret_string_valid", scope="session")
