...
Aspects.of(app).add(
    ApplyVpcOnCustomResource(
        ...
        security_group_logical_ids=stack.auth_construct.cdk_lambdas_vpc_construct.security_groups,
        subnet_names=stack.auth_construct.cdk_lambdas_vpc_construct.subnets,
    )
)
