...
# AWS Libraries
from aws_cdk import App, assertions, aws_lambda

# CMS Common Library
from cms_common.config.stack_inputs import S3AssetConfigInputs, SolutionConfigInputs

# Connected Mobility Solution on AWS
from ....infrastructure.cms_connect_store_stack import CmsConnectStoreStack
...
@pytest.fixture(name="cms_connect_store_stack_template", scope="session")
def fixture_cms_connect_store_stack_template() -> assertions.Template:
    ...
    with tempfile.TemporaryDirectory() as tmpdirname:
        ...
        app = App()
        stack = CmsConnectStoreStack(
            app,
            "cms-connect-store-stack",
