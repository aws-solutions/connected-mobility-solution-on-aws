...
app = aws_cdk.App()
stack = CmsPredictiveMaintenanceStack(
    app,
...
aws_cdk.Aspects.of(app).add(
    ApplyVpcOnCustomResource(
        ...
        security_group_logical_ids=stack.cms_predictive_maintenance_construct.cdk_lambdas_vpc_construct.security_groups,
        subnet_names=stack.cms_predictive_maintenance_construct.cdk_lambdas_vpc_construct.subnets,
    )
)
