...
def handler(event: Dict[str, Any], context: LambdaContext) -> Dict[str, Any]:
    response = {"Status": CustomResourceStatusType.FAILED.value, "Data": {}}

    resource_map = {
        CustomResourceFunctionType.LOAD_OR_CREATE_IOT_CREDENTIALS.value: load_or_create_iot_credentials,
        CustomResourceFunctionType.UPDATE_EVENT_CONFIGURATIONS.value: update_event_configurations,
        CustomResourceFunctionType.DELETE_PROVISIONING_CERTIFICATE.value: delete_provisioning_certificate,
    }
...
def delete_provisioning_certificate(event: Dict[str, Any]) -> None:
    if event["RequestType"] == CustomResourceRequestType.DELETE.value:
        try:
