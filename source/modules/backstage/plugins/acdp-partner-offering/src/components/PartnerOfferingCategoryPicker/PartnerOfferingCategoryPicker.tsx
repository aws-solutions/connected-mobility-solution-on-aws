...
/** @alpha */
export type PartnerOfferingReactCategoryPickerClassKey = "root" | "label";
 ...
 * categories and filtering the partner offerings list.
 * @alpha
 */
export const PartnerOfferingCategoryPicker = () => {
