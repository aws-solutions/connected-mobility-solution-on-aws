...
export const ACDP_DEPLOYMENT_TARGET_ACCOUNT_ANNOTATION =
  "aws.amazon.com/acdp-deployment-target-account";
export const ACDP_DEPLOYMENT_TARGET_REGION_ANNOTATION =
  "aws.amazon.com/acdp-deployment-target-region";
