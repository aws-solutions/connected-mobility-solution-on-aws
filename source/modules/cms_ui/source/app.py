...
from .infrastructure.cms_ui_stack import CmsUIStack
...
Aspects.of(app).add(
    ApplyVpcOnCustomResource(
        ...
        security_group_logical_ids=stack.cms_ui_construct.cdk_lambdas_vpc_construct.security_groups,
        subnet_names=stack.cms_ui_construct.cdk_lambdas_vpc_construct.subnets,
    )
)
