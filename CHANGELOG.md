...
- Fixes for model generation script. Pin to VSS v4.0.
- @KennyTakaki - Fix in CMS Vehicle Simulator for delete modal index issue.
...
- Upgraded backstage version to 1.37.0.
- Added Smithy to VSCode devcontainer.
- Added resolution for rjsf/utils package to fix backstage build.
- Fixed breaking changes to the createTemplateAction function.
