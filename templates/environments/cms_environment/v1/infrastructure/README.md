# Connected Mobility Solution on AWS - Environment
...
The CMS Environment exists to provide cross module infrastructure, configuration, and support.

## Solution Details

List of functionality
- Setup IoT Core logging
