...
@pytest.fixture(name="lambda_env_vars", scope="session")
def fixture_lambda_env_vars() -> Dict[str, str]:
    return {
...
def fixture_mock_env_vars(
    aws_credentials_env_vars: Dict[str, str], lambda_env_vars: Dict[str, str]
